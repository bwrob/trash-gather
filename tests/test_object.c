 ...
 */
munit_case(RUN, test_create_empty_list, {
  vm_new();
...
munit_case(RUN, test_list_set, {
  ...
  assert_ptr(obj->data.v_list.elements[0], ==, first, "Should set the first element");
  assert_ptr(obj->data.v_list.elements[1], ==, second, "Should set the second element");
 ...
 */
munit_case(RUN, test_list_set_outside_bounds, {
  vm_new();
  object_t *obj = new_list(2);
  ...
  assert_ptr(obj->data.v_list.elements[1], ==, outside,
 ...
 */
munit_case(SUBMIT, test_list_set_rejects_invalid_inputs, {
  vm_new();
 ...
 */
munit_case(RUN, test_list_get_empty_slot, {
  vm_new();
  object_t *obj = new_list(2);
 ...
 */
munit_case(SUBMIT, test_list_get_outside_bounds, {
  vm_new();
 ...
 */
munit_case(SUBMIT, test_list_get_rejects_invalid_inputs, {
  vm_new();
  object_t *not_list = new_integer(5);
