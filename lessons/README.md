...
| **04** | [Polymorphic Sequence Protocol & Const Invariants](04_polymorphic_sequence_protocol_and_const_qualifiers.md) | Tagged union sequence protocol, `const` pointer semantics, preprocessor macro comma pitfalls, and unified API namespacing.                                  |
| **05** | [Immortal Singletons & PEP 683 Architecture](05_immortal_objects_and_pep683.md)                              | PEP 683 fixed refcounts (`SIZE_MAX`), C17 file-scope `const` linkage trap, eager startup rollback, cyclic GC bypass, and bootlib scoped checkpoints.        |
